...
public class CustomUserServiceImpl implements UserDetailsService {
	...
	public UserDetails loadUserByUsername(String username) throws UsernameNotFoundException {
		...
		if (username.startsWith(SELLER_PREFIX)) {
			...
			String actualUserDetails = username.substring(SELLER_PREFIX.length());
			Seller seller = sellerRepository.findByEmail(actualUserDetails);
		...
		throw new UsernameNotFoundException("User or seller not found with this gmail " + username);
